...
Run the [ContinuousGesturePredictor.py](https://github.com/piyusharma4/Fingure-Gesture-based-recognition-using-OpenCV-and-CNN/ContinuousGesturePredictor.py) file and you will see a window named **Video Feed** appear on screen. Wait for a while until a window named **Thresholded** appears.
...
![Alt Text](https://github.com/piyusharma4/Fingure-Gesture-based-recognition-using-OpenCV-and-CNN/Demo.gif)
